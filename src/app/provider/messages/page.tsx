  ...
  const chats = [
    {
      id: '1',
      name: 'John Doe',
      lastMessage: 'I have shared the location, please check.',
      time: '2m ago',
      unread: true,
    ...
    },
    {
      id: '2',
      name: 'Amna Ahmed',
      lastMessage: 'Are you available for tomorrow?',
      time: '1h ago',
      unread: false,
    ...
    },
    {
      id: '3',
      name: 'Sarah Khan',
      lastMessage: 'The driver was very professional. Thank you!',
      time: 'Yesterday',
      unread: false,
      ...
      <header className="bg-primary px-6 pt-16 pb-10 space-y-6 rounded-b-[40px] shadow-lg relative overflow-hidden">
        <div className="relative z-10 flex justify-between items-center">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl font-black tracking-tight text-white leading-none">{t('chats')}</h1>
              <p className="text-primary-foreground/80 font-medium text-xs mt-1">Stay in touch with your customers</p>
            </div>
          </div>
            ...
            >
              ...
              <div className="flex-1 min-w-0 space-y-1">
                ...
                <div className="flex items-center gap-2">
                  <Badge variant="outline" className="text-[8px] font-black uppercase tracking-widest h-4 px-1.5 border-primary/20 text-primary bg-primary/5">
                    Customer
                  </Badge>
                </div>
